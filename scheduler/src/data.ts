export const displayDate = new Date("2023-03-08T08:00:00.000Z");
export const data = [
  {
    id: 0,
    ...
    recurrenceExceptions: [
      new Date("2019-09-25T07:30:00.000Z"),
      new Date("2019-09-26T07:30:00.000Z"),
    ],
  },
  {
    id: 1,
    title: "Breakfast at the office",
    start: new Date("2023-03-08T08:30:00.000Z"),
    end: new Date("2023-03-08T09:00:00.000Z"),
    recurrenceRule: "FREQ=DAILY;BYDAY=MO,WE,FR",
    recurrenceExceptions: [
        new Date("2023-03-25T07:30:00.000Z"),
        new Date("2023-03-26T07:30:00.000Z"),
      ],
  },
  {
    id: 2,
